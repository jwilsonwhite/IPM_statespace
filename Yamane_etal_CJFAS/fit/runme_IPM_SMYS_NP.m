function[]=runme_IPM_SMYS_NP(varargin)
% Run South Coast IPM model
...
% at a time, and to be used for fitting model to pre-2012 data

% Site: can be an MPA region (Naples) 

% Species: 
% SMYS (Sebastes mystinus, blue rockfish) 

% Type: pre2012 % describes the type of fitting to be done.
