...
load('PCLA_Pt_Lobos_pre2007_31Aug2015_metadata.mat')
...
F1 = 0.15; % F during burn-in
F2 = 0.15; % F during data collection

% Time structure of the data:
% baseline: 9 years for burnin, 9 years for fit
T1 = 9;
T2 = 9; % other values = 3, 6, 12, 15
T = T1 + T2;

% length bin width
BinW = 3;

savename = 'PCLA_mockdata_F0.15_8Aug2018';
